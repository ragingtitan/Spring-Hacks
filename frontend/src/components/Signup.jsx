  ...
  return (
    <div className="h-screen bg-white flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      ...
      <div className="max-w-md w-full space-y-8">
        <form
          className="mt-8 space-y-6 text-black flex flex-col gap-5 bg-gradient-to-r from-blue-500 to-purple-600 p-8 rounded-lg shadow-lg"
          onSubmit={handleSubmit}
        >
          <div>
            <h2 className="mt-6 w-full text-center text-3xl font-extrabold text-white">
